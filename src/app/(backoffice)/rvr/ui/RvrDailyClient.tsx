...
import { createDefaultRvrChecklist, RvrChecklistRow, RVR_MAX_BUSES_PER_DAY } from "@/lib/rvr";
    ...
    <div className="mobile-page-shell space-y-4">
      <header className="mobile-page-header">
        <div className="mx-auto w-full max-w-[1600px] px-4 py-4 lg:px-6 lg:py-0">
          ...
          <p className="text-sm text-muted-foreground">Máx. {RVR_MAX_BUSES_PER_DAY} buses diarios (1 semana desde preventivo finalizado).</p>
        </div>
      </header>
      <div className="mobile-page-content max-w-[1600px] space-y-4 lg:px-6">
        ...
        <section className="mobile-section-card mobile-section-card__body">
          <h2 className="text-base font-semibold">Buses elegibles</h2>
        ...
        {selectedBuses.map((bus) => (
          <section key={bus.busId} className="mobile-section-card mobile-section-card__body space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <h3 className="text-base font-semibold">{bus.busCode} <span className="font-normal text-muted-foreground">{bus.busPlate ?? "Sin placa"}</span></h3>
